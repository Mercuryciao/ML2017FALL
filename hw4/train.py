...
parser.add_argument('--vocab_size', default=5225, type=int)
...
parser.add_argument('--train_p', default = '')
parser.add_argument('--semi_p', default = '')

args = parser.parse_args()

train_path = args.train_p#'data/training_label.txt'
#test_path = #'data/testing_data.txt'
semi_path = args.semi_p#'data/training_nolabel.txt'
